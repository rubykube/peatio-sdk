...
PeatioSdk - JavaScript client for peatio_sdk
...
Finally, switch to the directory you want to use your peatio_sdk from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('peatio_sdk')` in javascript files from the directory you ran the last 
command above from.
