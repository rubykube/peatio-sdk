...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiPeatio.K_with_pending_tradesApi();
  });
  ...
  describe('K_with_pending_tradesApi', function() {
    describe('getV2KWithPendingTrades', function() {
      it('should call getV2KWithPendingTrades successfully', function(done) {
