...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiPeatio.Deposit_addressApi();
  });
  ...
  describe('Deposit_addressApi', function() {
    describe('getV2DepositAddress', function() {
      it('should call getV2DepositAddress successfully', function(done) {
